...
enum {
  IMX8MN_PAD_BOOT_MODE2__CCMSRCGPCMIX_BOOT_MODE2 =
      IOMUX_PAD(0x025C, 0x0020, 0, 0x0000, 0, 0),
  IMX8MN_PAD_BOOT_MODE2__I2C1_SCL =
      IOMUX_PAD(0x025C, 0x0020, 1 | IOMUX_CONFIG_SION, 0x055C, 3, 0),
  IMX8MN_PAD_BOOT_MODE3__CCMSRCGPCMIX_BOOT_MODE3 =
      IOMUX_PAD(0x0260, 0x0024, 0, 0x0000, 0, 0),
  IMX8MN_PAD_BOOT_MODE3__I2C1_SDA =
      IOMUX_PAD(0x0260, 0x0024, 1 | IOMUX_CONFIG_SION, 0x056C, 3, 0),
  IMX8MN_PAD_GPIO1_IO00__GPIO1_IO0 = IOMUX_PAD(0x0290, 0x0028, 0, 0x0000, 0, 0),
  IMX8MN_PAD_GPIO1_IO00__CCMSRCGPCMIX_ENET_PHY_REF_CLK_ROOT =
      IOMUX_PAD(0x0290, 0x0028, 1, 0x0000, 0, 0),
  IMX8MN_PAD_GPIO1_IO00__ANAMIX_REF_CLK_32K =
      IOMUX_PAD(0x0290, 0x0028, 5, 0x0000, 0, 0),
  IMX8MN_PAD_GPIO1_IO00__CCMSRCGPCMIX_EXT_CLK1 =
      IOMUX_PAD(0x0290, 0x0028, 6, 0x0000, 0, 0),
