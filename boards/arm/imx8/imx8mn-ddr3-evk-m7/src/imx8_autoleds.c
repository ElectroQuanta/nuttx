/****************************************************************************
 * boards/arm/imx8/imx8mn-ddr-evk-m7/src/imx8_autoleds.c
 *
 ...
 * include/board.h and src/imx8_autoleds.c. The LED is used to encode
...
void board_autoled_on(int led)
{
  ...
  imx8_gpio_write(GPIO_LED, ledoff); /* Low illuminates */
}
...
void board_autoled_off(int led)
{
  ...
  imx8_gpio_write(GPIO_LED, true); /* Low illuminates */
}
