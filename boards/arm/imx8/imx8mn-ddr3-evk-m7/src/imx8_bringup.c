/****************************************************************************
 * boards/arm/imx8/imx8mn-ddr-evk-m7/src/imx8_bringup.c
 *
...
/* #include <imx8_lpi2c.h> */
/* #include <imx8_lpspi.h> */

#ifdef CONFIG_IMX8_USDHC
#  include "imx8_usdhc.h"
#endif

#include "imx8mn-ddr3-evk-m7.h"
...
#if defined(CONFIG_I2C_DRIVER) && defined(CONFIG_IMX8_LPI2C)
static void imx8_i2c_register(int bus)
{
  struct i2c_master_s *i2c;
  int ret;

  i2c = imx8_i2cbus_initialize(bus);
  if (i2c == NULL)
    {
...
int imx8_bringup(void)
{
...
#if defined(CONFIG_I2C_DRIVER) && defined(CONFIG_IMX8_LPI2C1)
  imx8_i2c_register(1);
#endif
  ...
  imx8_spidev_initialize();

  ret = imx8_mmcsd_spi_initialize(MMCSD_MINOR);
  if (ret < 0)
    {
