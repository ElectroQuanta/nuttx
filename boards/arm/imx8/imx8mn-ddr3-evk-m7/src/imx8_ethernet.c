/****************************************************************************
 * boards/arm/imx8/imx8mn-ddr-evk-m7/src/imx8_ethernet.c
 *
...
#ifdef CONFIG_IMX8_ENET

/****************************************************************************
 * Pre-processor Definitions
 ****************************************************************************/

#define IMX8_ENET_DEVNAME "eth0"
...
/****************************************************************************
 * Name: imx8_enet_phy_enable
 ****************************************************************************/

#ifdef CONFIG_IMX8_GPIO1_0_15_IRQ
static void imx8_enet_phy_enable(bool enable)
{
...
/****************************************************************************
 * Function: imx8_phy_boardinitialize
 *
 * Description:
 ...
 *  etc.
 *  If CONFIG_IMX8_ENET_PHYINIT is defined in the configuration then the
 *  board specific logic must provide imx8_phyinitialize();
...
int imx8_phy_boardinitialize(int intf)
{
#ifdef CONFIG_IMX8_GPIO1_0_15_IRQ
  /* Configure the PHY interrupt pin */

  phyinfo("Configuring interrupt: %08x\n", GPIO_ENET_INT);
  imx8_config_gpio(GPIO_ENET_INT);
#endif
  ...
  imx8_config_gpio(GPIO_ENET_RST);

  /* Take the PHY out of reset. */

  imx8_gpio_write(GPIO_ENET_RST, true);
#endif
  return OK;
}
                 ...
                 phy_enable_t *enable)
{
  ...
  if (strcmp(intf, IMX8_ENET_DEVNAME) == 0)
    {
      irq     = GPIO_ENET_IRQ;
      enabler = imx8_enet_phy_enable;
    }
  else
    {
  ...
  if (handler)
    {
       ...
       * input (by imx8_phy_boardinitialize() above).
       *
...
#endif /* CONFIG_IMX8_GPIO1_0_15_IRQ */

#endif /* CONFIG_IMX8_ENET */
