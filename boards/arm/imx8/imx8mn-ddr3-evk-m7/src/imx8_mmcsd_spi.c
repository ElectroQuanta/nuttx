/****************************************************************************
 * boards/arm/imx8/imx8-ddr3-evk-m7/src/imx8_mmcsd_spi.c
 *
...
#ifndef CONFIG_IMX8_LPSPI1
#  error "SD driver requires CONFIG_IMX8_LPSPI1 to be enabled"
#endif
...
int imx8_lpspi1register(struct spi_dev_s *dev, spi_mediachange_t callback,
                       void *arg)
{
...
int imx8_mmcsd_spi_initialize(int minor)
{
  ...
  spi = imx8_lpspibus_initialize(SD_SPI_PORT);
  if (spi == NULL)
    {
