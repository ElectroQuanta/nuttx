/****************************************************************************
 * boards/arm/imx8mn/imx8mn-ddr3-evk-m7/include/board.h
 *
...
#ifndef __BOARDS_ARM_IMX8MN_IMX8MN_DDR3_EVK_M7_INCLUDE_BOARD_H
#define __BOARDS_ARM_IMX8MN_IMX8MN_DDR3_EVK_M7_INCLUDE_BOARD_H
 ...
 *
 *     AHB_CLOCK_ROOT             = PLL1fOut / IMX8MN_AHB_PODF_DIVIDER
 *     1Hz to 600 MHz             = 600Mhz / IMX8MN_ARM_CLOCK_DIVIDER
 *                        IMX8MN_ARM_CLOCK_DIVIDER = 1
 *                        600Mhz  = 600Mhz / 1
 *
 ...
 *     PERIPH_CLK                 = 600Mhz
 *
 *     IPG_CLOCK_ROOT             = AHB_CLOCK_ROOT / IMX8MN_IPG_PODF_DIVIDER
 *                       IMX8MN_IPG_PODF_DIVIDER = 4
 *                       150Mhz = 600Mhz / 4
 *
 *     PERCLK_CLOCK_ROOT          = IPG_CLOCK_ROOT /
 *                                  IMX8MN_PERCLK_PODF_DIVIDER
 *                       IMX8MN_PERCLK_PODF_DIVIDER = 9
 *                       16.6Mhz  = 150Mhz / 9
 *
 *     SEMC_CLK_ROOT              = 600Mhz / IMX8MN_SEMC_PODF_DIVIDER
 *                                           (labeled AIX_PODF in 18.2)
 *                       IMX8MN_SEMC_PODF_DIVIDER = 8
 *                       75Mhz    = 600Mhz / 8
 *
 ...
 *
 *   putreg32( <Clk number> | CCM_CCOSR_CLKO1_EN ,   IMX8MN_CCM_CCOSR);
 *   imx8mn_config_gpio(GPIO_CCM_CLKO1);
 */

#define BOARD_XTAL_FREQUENCY       24000000
#define IMX8MN_PRE_PERIPH_CLK_SEL   CCM_CBCMR_PRE_PERIPH_CLK_SEL_PLL1
#define IMX8MN_PERIPH_CLK_SEL       CCM_CBCDR_PERIPH_CLK_SEL_PRE_PERIPH
#define IMX8MN_ARM_PLL_DIV_SELECT   100
#define IMX8MN_ARM_PODF_DIVIDER     2
#define IMX8MN_AHB_PODF_DIVIDER     1
#define IMX8MN_IPG_PODF_DIVIDER     4
#define IMX8MN_PERCLK_CLK_SEL       CCM_CSCMR1_PERCLK_CLK_SEL_IPG_CLK_ROOT
#define IMX8MN_PERCLK_PODF_DIVIDER  9
#define IMX8MN_SEMC_PODF_DIVIDER    8
#define IMX8MN_LPSPI_CLK_SELECT     CCM_CBCMR_LPSPI_CLK_SEL_PLL3_PFD0
#define IMX8MN_LSPI_PODF_DIVIDER    8

#define IMX8MN_LPSPI_CLK_SELECT     CCM_CBCMR_LPSPI_CLK_SEL_PLL3_PFD0
#define IMX8MN_LSPI_PODF_DIVIDER    8

#define IMX8MN_LPI2C_CLK_SELECT     CCM_CSCDR2_LPI2C_CLK_SEL_PLL3_60M
#define IMX8MN_LSI2C_PODF_DIVIDER   5

#define IMX8MN_USDHC1_CLK_SELECT    CCM_CSCMR1_USDHC1_CLK_SEL_PLL2_PFD0
#define IMX8MN_USDHC1_PODF_DIVIDER  2

#define IMX8MN_SYS_PLL_SELECT       CCM_ANALOG_PLL_SYS_DIV_SELECT_22

#define IMX8MN_USB1_PLL_DIV_SELECT  CCM_ANALOG_PLL_USB1_DIV_SELECT_20

#define BOARD_CPU_FREQUENCY \
  (BOARD_XTAL_FREQUENCY * (IMX8MN_ARM_PLL_DIV_SELECT / 2)) / IMX8MN_ARM_PODF_DIVIDER

/* Define this to enable tracing */

#if 0
#  define IMX8MN_TRACE_PODF_DIVIDER 1
#  define IMX8MN_TRACE_CLK_SELECT   CCM_CBCMR_TRACE_CLK_SEL_PLL2_PFD0
#endif
 ...
 * include/board.h and src/imx8mn_autoleds.c. The LED is used to encode
...
/* The IMX8MN board has one external user button
 *
...
#endif /* __ASSEMBLY__ */
#endif /* __BOARDS_ARM_IMX8MN_IMX8MN_DDR3_EVK_M7_INCLUDE_BOARD_H */
